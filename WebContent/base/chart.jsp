...
<title> 统计图表－基于JAVA的分布式企业配置管理系统</title>
</head>
<body>
...
<div id="main-container-outter">
	<div id="main-container-inner">
		<div id="crumb" class="clearBorder">当前位置<span class="to"></span><a href="action/global/index">系统概览</a><span class="to"></span>统计图表</div>
		<div class="noteword">
			<p>以下是系统运行数据的图表展示，使您更直观的了解系统运行情况！</p>
		</div>
		<div id="view-mode">
			<div class="l">
				...
				<c:forEach var="gb" items="${groupbys }" varStatus="status">
					...
					<c:choose>
						...
						<c:otherwise>
							<a href="action/global/chart?dataid=${dataid }&groupname=${groupname }&content=${content }&action=${action }&username=${username }&groupby=${gb}" title="按${groupbyLabels[status.index] }查看">${groupbyLabels[status.index] }</a>
						</c:otherwise>
					</c:choose>
		...
		<div class="result-tip">
			...
			<p class="search-item">
				<span class="query-key-container">
					...
					<span class="query-value">${dataid }<span class="query-item-close"><a href="action/global/chart?dataid=&groupname=${groupname }&content=${content }&addtime=${addtime }&action=${action }&username=${username }&groupby=${groupby }&page=${pager.currentPage}&countPerPage=${pager.countPerPage}" title="删除这个查找条件">关闭</a></span></span>
				</span>
			</p>
			</c:if>
			...
			<p class="search-item">
				<span class="query-key-container">
					...
					<span class="query-value">${groupname }<span class="query-item-close"><a href="action/global/chart?dataid=${dataid }&groupname=&content=${content }&addtime=${addtime }&action=${action }&username=${username }&groupby=${groupby }&page=${pager.currentPage}&countPerPage=${pager.countPerPage}" title="删除这个查找条件">关闭</a></span></span>
				</span>
			</p>
			</c:if>
			...
			<p class="search-item">
				<span class="query-key-container">
					...
					<span class="query-value">${content }<span class="query-item-close"><a href="action/global/chart?dataid=${dataid }&groupname=${groupname }&content=&addtime=${addtime }&action=${action }&username=${username }&groupby=${groupby }&page=${pager.currentPage}&countPerPage=${pager.countPerPage}" title="删除这个查找条件">关闭</a></span></span>
				</span>
			</p>
			</c:if>
			...
			<p class="search-item">
				<span class="query-key-container">
					...
					<span class="query-value">${action }<span class="query-item-close"><a href="action/global/chart?dataid=${dataid }&groupname=${groupname }&content=&addtime=${addtime }&action=&username=${username }&groupby=${groupby }&page=${pager.currentPage}&countPerPage=${pager.countPerPage}" title="删除这个查找条件">关闭</a></span></span>
				</span>
			</p>
			</c:if>
			...
			<p class="search-item">
				<span class="query-key-container">
					...
					<span class="query-value">${username }<span class="query-item-close"><a href="action/global/chart?dataid=${dataid }&groupname=${groupname }&content=&addtime=${addtime }&action=${action }&username=&groupby=${groupby }&page=${pager.currentPage}&countPerPage=${pager.countPerPage}" title="删除这个查找条件">关闭</a></span></span>
				</span>
			</p>
			</c:if>
		...
		<div class="box">
			<div id="quick-search">
			<form action="action/global/chart" method="get">
				<div class="line-1">
			...
			<div class="display-chart-container">
				<div class="display-chart">
					<a href="action/global/showChart?type=柱状图&charttype=GLOBAL_BAR&dataid=${dataid }&groupname=${groupname }&content=${content }&action=${action }&username=${username }&groupby=${groupby }" title="点击进入柱状图模式"><img src="common/images/loading.gif" onload="javascript:this.src='chart?charttype=GLOBAL_BAR&dataid=${dataid }&groupname=${groupname }&content=${content }&action=${action }&username=${username }&groupby=${groupby }';"" class="chart-img"/></a>
				</div>
			</div>
			<div class="display-chart-container">
				<div class="display-chart">
					<a href="action/global/showChart?type=折线图&charttype=GLOBAL_LINE&dataid=${dataid }&groupname=${groupname }&content=${content }&action=${action }&username=${username }&groupby=${groupby }" title="点击进入折线图模式"><img src="common/images/loading.gif" onload="javascript:this.src='chart?charttype=GLOBAL_LINE&dataid=${dataid }&groupname=${groupname }&content=${content }&action=${action }&username=${username }&groupby=${groupby }';"" class="chart-img"/></a>
				</div>
			</div>
			<div class="display-chart-container">
				<div class="display-chart">
					<a href="action/global/showChart?type=饼图&charttype=GLOBAL_PIE&dataid=${dataid }&groupname=${groupname }&content=${content }&action=${action }&username=${username }&groupby=${groupby }" title="点击进入饼图模式"><img src="common/images/loading.gif" onload="javascript:this.src='chart?charttype=GLOBAL_PIE&dataid=${dataid }&groupname=${groupname }&content=${content }&action=${action }&username=${username }&groupby=${groupby }';"" class="chart-img"/></a>
				</div>
			</div>
			<div class="display-chart-container">
				<div class="display-chart">
...
<div id="menu-container-outter">
	<div id="menu-container-inner">
		...
		<ul class="menulist">
			...
			<li>
				<a href="action/global/chart" class="current"><span class="m-to-i"></span><img src="common/images/chart.png" class="icon fixpos"/><span>统计图表</span></a>
				<ul class="child-menu">
