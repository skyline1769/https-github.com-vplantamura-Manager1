...
<div id="main-container-outter">
	<div id="main-container-inner">
		...
		<div class="box">
			<form action="action/bak/add" method="post">
				<div class="line">
				...
				<div class="line btContainer common-bt-blank">
					<input type="submit" value="添加" class="common-bt" />
