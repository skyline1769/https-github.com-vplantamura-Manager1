...
<div id="crumb" class="clearBorder">当前位置<span class="to"></span><a href="action/global/index">系统概览</a><span class="to"></span><a href="action/global/home">我的主页</a><span class="to"></span><a href="action/data/myData">我的配置</a><span class="to"></span>查看备用配置 </div>
<div id="main-container-outter">
	<div id="main-container-inner">
		<div class="noteword">订阅键[<span class="bold red">${data.dataid }</span>]的备用配置详细如下所示</div>
		...
		<div class="box">
			...
			<div class="line btContainer common-long-bt-blank">
				<input type="button" value="返回我的配置" class="common-bt" onclick="goUrl('action/data/myData')" />
	...
	<div class="outter-border" style="margin:0px auto;border-color:#6f6f6f;">
		<div class="inner-container">
			...
			<div class="dialogBottom">
				<input type="button" class="common-bt" id="setDataConfig-bt" onclick="goUrl('action/bak/setDataConfig?id=${model.id }&did=${data.id}&dataid=${data.dataid}&groupname=${data.groupname }&content=${model.content}&username=${data.username }&location=myData');" value="确认并设置为默认配置"/>
